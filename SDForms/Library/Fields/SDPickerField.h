...
@property (nonatomic, readonly) NSArray *relatedObjects;  ///< Array of field's related objects
@property (nonatomic, readonly) NSArray *relatedPropertyKeys; ///< Array of key paths to related objects' properties related to the field
@property (nonatomic, readonly) NSArray *formattedValueKeys;  ///< Array of key paths to related objects' properties that will be dispayed as field's formatted value
@property (nonatomic, readonly) NSArray *settableFormattedValueKeys;  ///< Array of key paths to related objects' properties that will be set by the field with its formattedValue property value
